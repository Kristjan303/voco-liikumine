...
app.post('/submit-trennid', (req, res) => {
    ...
    const sql = `INSERT INTO trennid (kasutaja_id, trenni_toimumise_algusaeg, trenni_toimumise_lõppaeg,
                                      trenni_toimumise_päev, asukoht, trenni_lisamise_kuupäev, trenni_selgitus,
                                      trenni_nimi, trenni_värv, trenni_klass)
                 VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)`;
...
app.get('/fetch-trennid', (req, res) => {
    ...
    const sql = `SELECT trennid.kasutaja_id,
                        kasutajad.kasutajanimi AS kasutaja_nimi,
                        trennid.trenni_nimi,
                        trennid.asukoht,
                        trennid.trenni_toimumise_päev,
                        trennid.trenni_toimumise_algusaeg,
                        trennid.trenni_toimumise_lõppaeg,
                        trennid.trenni_lisamise_kuupäev,
                        trennid.trenni_selgitus,
                        trennid.trenni_värv,
                        trennid.trenni_klass,
                        trennid.trenni_id
                 FROM trennid
...
app.get('/fetch-user-trennid', (req, res) => {
    ...
    const sql = `SELECT trennid.trenni_nimi,
                        trennid.asukoht,
                        trennid.trenni_toimumise_päev,
                        trennid.trenni_toimumise_algusaeg,
                        trennid.trenni_toimumise_lõppaeg,
...
app.post('/fetch-student-trennid', (req, res) => {
    ...
    const query = `
        SELECT tk.*,
               ...
               t.trenni_klass,
               t.trenni_värv,
               t.trenni_toimumise_päev,
               t.trenni_toimumise_algusaeg,
               t.trenni_toimumise_lõppaeg,
               t.trenni_selgitus,
               t.trenni_id,
               t.trenni_lisamise_kuupäev
...
app.post('/delete-registration', (req, res) => {
    ...
    db.query(deleteQuery1, [kasutaja_id, trenniId], (error1, results1) => {
        ...
        const deleteQuery2 = `DELETE
                              FROM trennis_osalejad
                              WHERE kasutaja_id = ?
                                AND trenni_id = ?`;
...
app.post('/delete-trenn', (req, res) => {
    ...
    const deleteTrennisKaijadQuery = `DELETE
                                      FROM trennis_käijad
                                      WHERE trenni_id = ?`;
    ...
    // Delete from trennid
    const deleteTrennidQuery = `DELETE
                                FROM trennid
                                WHERE trenni_id = ?`;
    ...
    const deleteTrennisOsalejadQuery = `DELETE
                                        FROM trennis_osalejad
                                        WHERE trenni_id = ?`;
